...
/* Line 189 of yacc.c  */
#line 105 "tp_integrador_ssl.tab.c"
...
/* Line 214 of yacc.c  */
#line 181 "tp_integrador_ssl.tab.c"
} YYSTYPE;
...
/* Line 264 of yacc.c  */
#line 193 "tp_integrador_ssl.tab.c"
...
{
       0,    86,    86,    87,    90,    91,    92,    99,   102,   103,
     106,   107,   110,   111,   114,   115,   118,   119,   122,   123,
     126,   127,   130,   131,   134,   135,   136,   137,   140,   141,
     142,   147,   148,   149,   152,   153,   156,   157,   158,   159,
     166,   167,   168,   171,   174,   177,   178,   183,   186,   187,
     188,   191,   192,   195,   196,   199,   205,   206,   207,   208,
     209,   212,   215,   216,   217,   220,   221,   224,   225,   226,
     229,   230,   233,   234,   235,   238,   239,   240,   243,   246,
...
/* Line 1455 of yacc.c  */
#line 102 "tp_integrador_ssl.y"
    {(yyval.nomTip) = (yyvsp[(1) - (1)].nomTip);;}
    break;

  case 9:

/* Line 1455 of yacc.c  */
#line 103 "tp_integrador_ssl.y"
    {(yyval.nomTip) = (yyvsp[(1) - (3)].nomTip);;}
    break;

  case 10:

/* Line 1455 of yacc.c  */
#line 106 "tp_integrador_ssl.y"
    {(yyval.nomTip) = (yyvsp[(1) - (1)].nomTip);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 107 "tp_integrador_ssl.y"
    {(yyval.nomTip) = (yyvsp[(1) - (5)].nomTip);;}
    break;

  case 12:

/* Line 1455 of yacc.c  */
#line 110 "tp_integrador_ssl.y"
    {(yyval.nomTip) = (yyvsp[(1) - (1)].nomTip);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 131 "tp_integrador_ssl.y"
    {(yyval.nomTip) = (yyvsp[(1) - (3)].nomTip); if (strcmp((yyvsp[(1) - (3)].nomTip).tipo, (yyvsp[(3) - (3)].nomTip).tipo) != 0) {printf("\nError de tipos en operacion multiplicativa. (linea %i)", linea);};}
    break;

  case 24:

/* Line 1455 of yacc.c  */
#line 134 "tp_integrador_ssl.y"
    {(yyval.nomTip) = (yyvsp[(1) - (1)].nomTip);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 135 "tp_integrador_ssl.y"
    {(yyval.nomTip) = (yyvsp[(2) - (2)].nomTip);;}
    break;

  case 26:

/* Line 1455 of yacc.c  */
#line 136 "tp_integrador_ssl.y"
    {(yyval.nomTip) = (yyvsp[(2) - (2)].nomTip);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 142 "tp_integrador_ssl.y"
    {simboloAux = buscarSimbolo((yyvsp[(1) - (4)].nomTip).nombre); if (simboloAux != NULL) {if (compararParametros(&(simboloAux->tiposParametros), &listaParametrosAux) != 0) {printf("\nError semantico: cantidad o tipos de parametros incorrectos en invocacion de la funcion %s. (linea %i)", simboloAux->nombre, linea);}}
                                                                        else {printf("\nError semantico: la funcion %s es invocada sin previa declaracion. (linea %i)", (yyvsp[(1) - (4)].cadena), linea);}
...
/* Line 1455 of yacc.c  */
#line 148 "tp_integrador_ssl.y"
    {add(&listaParametrosAux, (yyvsp[(1) - (1)].nomTip).tipo);;}
    break;

  case 33:

/* Line 1455 of yacc.c  */
#line 149 "tp_integrador_ssl.y"
    {add(&listaParametrosAux, (yyvsp[(3) - (3)].nomTip).tipo);;}
    break;

  case 34:

/* Line 1455 of yacc.c  */
#line 152 "tp_integrador_ssl.y"
    {add(&listaParametrosAux, (yyvsp[(1) - (1)].nomTip).tipo);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 156 "tp_integrador_ssl.y"
    {simboloAux = buscarSimbolo((yyvsp[(1) - (1)].cadena)); if (simboloAux != NULL) {strcpy((yyval.nomTip).nombre, simboloAux->nombre); strcpy((yyval.nomTip).tipo, simboloAux->tipo);};}
    break;

  case 37:

/* Line 1455 of yacc.c  */
#line 157 "tp_integrador_ssl.y"
    {strcpy((yyval.nomTip).nombre, ""); strcpy((yyval.nomTip).tipo, (yyvsp[(1) - (1)].cadena));;}
    break;

  case 38:

/* Line 1455 of yacc.c  */
#line 158 "tp_integrador_ssl.y"
    {strcpy((yyval.nomTip).nombre, ""); strcpy((yyval.nomTip).tipo, "char*");;}
    break;

  case 43:

/* Line 1455 of yacc.c  */
#line 171 "tp_integrador_ssl.y"
...
/* Line 1455 of yacc.c  */
#line 1860 "tp_integrador_ssl.tab.c"
      default: break;
    }
